(function($) {
	...
	$(document).ready(function() {
		...
		var launchDay = new Date(2024, 2-1, 21);
		...
		***********************/
		if($("#bg-slide").length>0) {
			$.backstretch([
				"https://cdn-themes.thinkific.com/864476/385056/gx6l21WBQhuX1v1hnzPS_IMG_AllCoursesA2.jpg",
				"https://cdn-themes.thinkific.com/864476/385056/AJGgqvPIR1qI2Hj7iXxT_IMG_become_model.jpg",
				"https://cdn-themes.thinkific.com/864476/385056/vornO5ICTCuHvUA9km4t_CONTACT_US_IMAGE.jpg"
			], {
				fade:750,
				duration:4000
			});
